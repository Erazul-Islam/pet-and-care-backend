...
router.post('/pet-post', (0, validateRequest_1.default)(post_validation_1.postValidation.postValidationSchema), multer_config_1.multerUpload.single('photo'), post_controller_1.postController.addPostController);
